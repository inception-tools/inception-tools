...
from inceptiontools.directory_builder import DirectoryBuilder


class TemplateDirectoryBuilder(DirectoryBuilder):
    """
    An implementation of :py:class:`inceptiontools.DirectoryBuilder` which
    uses a :py:class:`jinja2.Template` to create the subpath for the
