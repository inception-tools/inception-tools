...
from inceptiontools.archetype_base import ArchetypeBase
from inceptiontools.archetype_descriptor import ArchetypeDescriptor
from inceptiontools.archetype_metadata import ArchetypeMetadata
from inceptiontools.template_directory_builder import TemplateDirectoryBuilder
...
class TemplateArchetype(ArchetypeBase):
    ...
    files to sub-paths within the projects created by ``inceptiontools``.
    """
